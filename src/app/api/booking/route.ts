...
export async function POST(req: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      ...
      replyTo: email,
      subject: `NEW BOOKING REQUEST from ${name} - ${phone}`,
      html: `
        ...
        <table style="border-collapse:collapse;width:100%">
          ...
          <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold">Location/Address</td><td style="padding:8px;border:1px solid #ddd">${address || 'Not specified'}</td></tr>
